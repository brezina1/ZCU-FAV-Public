...
\ifthenelse{\boolean{includeAnimations}}{
    \begin{landscapeimagepage}
        ...
        \begin{figure}[H]
            \centering
            \includeanimation{Generated/Ukázka Gaussovo funkce 4D/frame-}{12.5}{palindrome, height=0.6\textheight}
            % \includeanimation{Generated/4D surface demo 1/frame-}{12.5}{palindrome, height=0.5\textheight}
            \caption{Ukázka průběhu Gaussovo funkce $f(x,y,w)$}
            \label{fig:Ukázka Gaussovo funkce 4D}
        \end{figure}
        \vspace*{\fill}
...
\ifthenelse{\boolean{includeAnimationFrames}}{
    \begin{landscapeimagepage}
        ...
        \begin{figure}[H]
            \centering
            \includeanimationframes[\vspace{1cm}]{Generated/Ukázka Gaussovo funkce 4D/frame-}{width=0.28\pdfpageheight}
            \caption{Ukázka průběhu Gaussovo funkce $f(x,y,w)$}
            \label{fig:Ukázka Gaussovo funkce 4D}
        \end{figure}
        \vspace*{\fill}
    ...
    \begin{landscapeimagepage}
        ...
        \begin{figure}[H]
            ...
            \begin{subfigure}{.5\textheight}
                ...
                \caption{4D aproximace pro různé parametry Gaussovo funkce č.~1\\(Průhlednost aproximačních bodů odpovídá jejich vzdálenosti v ose $w$)}
                \label{fig:4D aproximace pro různé parametry Gaussovo funkce č. 1}
            \end{subfigure}
            \hspace{2.5cm}
            \begin{subfigure}{.5\textheight}
                \centering
                \includeanimation{Generated/4D surface gauss approx demo 2/frame-}{12.5}{palindrome, height=0.45\textheight}
                \caption{4D aproximace pro různé parametry Gaussovo funkce č.~2\\(Průhlednost aproximačních bodů odpovídá jejich vzdálenosti v ose $w$)}
                \label{fig:4D aproximace pro různé parametry Gaussovo funkce č. 2}
            \end{subfigure}
            \caption{Ukázka aproximace 4D povrchů s užitím Gaussovo funkce}
            \label{fig:Ukázka aproximace 4D povrchů s užitím Gaussovo funkce}
        \end{figure}
        \vspace*{\fill}
    \end{landscapeimagepage}}{}
\ifthenelse{\boolean{includeAnimationFrames}}{
