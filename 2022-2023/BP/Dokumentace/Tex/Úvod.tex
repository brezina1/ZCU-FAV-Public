...
\begin{enumerate}
    ...
    \item \nameref{section: NURBS teorie} --- obsáhlá kapitola, ve které je rozebrána veškerá teorie k NURBS křivkám/povrchům včetně kompletně vlastní implementace v Matlabu dle knížky \cite{The_NURBS_Book}. Kapitola obsahuje ukázky výsledků jednotlivých algoritmů na obecných datech.
...
\end{enumerate}
V práci jsou uvedeny znormované hodnoty poloh kloubů z důvodu důvěryhodnosti dat. V případě ukázky animací, je zobrazeno pouze 6 snímků pro tištěnou verzi, plná verze animace je obsažena v příloze či v digitální verzi dokumentace. Celá tato práce včetně zdrojového kódu je veřejně dostupná na GitHubu --- \todo{link}.
% \begin{imagepage}
